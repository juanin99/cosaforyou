...
import Controlador.GestorSalir;
...
public class Resultado extends JDialog 
{
	...
	private String user ="manolo";
	private JButton botonSalir;
	
	public Resultado(String title) 
	{
		setTitle(title);
		...
		botonSalir = new JButton ("Vete a tomar un McDonald's"); 
		...
		aceptarButton.addActionListener(new GestorSalir());
	...
	{
		Resultado mainWindow = new Resultado("Divisor de grupos");
